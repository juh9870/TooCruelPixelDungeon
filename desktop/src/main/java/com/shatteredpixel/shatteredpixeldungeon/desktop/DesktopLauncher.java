	...
	public static void main (String[] args) {
		...
		if (SharedLibraryLoader.isWindows) {
			if (System.getProperties().getProperty("os.name").equals("Windows XP")) {
				basePath = "Application Data/.cruelpixel/Too Cruel Pixel Dungeon/";
			} else {
				basePath = "AppData/Roaming/.cruelpixel/Too Cruel Pixel Dungeon/";
			}
		} else if (SharedLibraryLoader.isMac) {
			basePath = "Library/Application Support/Too Cruel Pixel Dungeon/";
