...
public class Warlock extends Mob implements Callback {
	...
	public Item createLoot(){
		...
		if (Random.Int(2) == 0 && Random.Int(8) > Dungeon.LimitedDrops.WARLOCK_HP.getCount()){
			Dungeon.LimitedDrops.WARLOCK_HP.setCount(Dungeon.LimitedDrops.WARLOCK_HP.getCount() + 1);
