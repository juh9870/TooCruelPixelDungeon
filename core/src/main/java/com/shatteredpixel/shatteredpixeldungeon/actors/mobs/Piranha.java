...
public class Piranha extends Mob {
	...
	public Piranha() {
		...
		HP = HT = 10 + Dungeon.scalingFactor() * 5;
		defenseSkill = 10 + Dungeon.scalingFactor() * 2;
	}
	...
	public int damageRoll() {
		return Random.NormalIntRange( Dungeon.scalingFactor(), 4 + Dungeon.scalingFactor() * 2 );
	}
	
	@Override
	public int attackSkill( Char target ) {
		return 20 + Dungeon.scalingFactor() * 2;
	}
	
	@Override
	public int drRoll() {
		return Random.NormalIntRange(0, Dungeon.scalingFactor());
	}
